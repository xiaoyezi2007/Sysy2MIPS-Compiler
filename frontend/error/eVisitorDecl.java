...
public class eVisitorDecl {
    private eVisitor eVisitor;

    public eVisitorDecl(eVisitor eVisitor) {
    ...
    public void visitVarDef(ASTNode node, String con, String btype) {
        ...
        eVisitor.addSymbol(children.get(0).getToken().getLine(), children.get(0).getValue(), type, btype, con);
    ...
    public void visitConstExp(ASTNode node) {
        eVisitorExp eVisitorExp = new eVisitorExp(eVisitor);
        eVisitorExp.visitAddExp(node.getChildren().get(0));
    }
